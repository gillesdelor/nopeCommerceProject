...
class SearchCustomer:
    ...
    txtFirsName_id = "SearchFirstName"
    txtLastName_id = "SearchLastName"
    btnSearch_id = "search-customers"

    tableSearchResult_xpath = "//div[@class='dataTables_scrollBody']"
    ...
    def setFirstName(self, fname):
        self.driver.find_element_by_id(self.txtFirsName_id).clear()
        self.driver.find_element_by_id(self.txtFirsName_id).send_keys(fname)
    ...
    def searchCustomerBy_Email(self, email):
        flag = False
    ...
    def searchCustomerBy_Name(self, Name):
        flag = False
        for r in range(1, self.getNoOfRows() + 1):
            table = self.driver.find_element_by_xpath(self.table_xpath)
